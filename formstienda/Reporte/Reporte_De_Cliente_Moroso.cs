...
namespace formstienda.Reporte
{
    public partial class Reporte_De_Cliente_Moroso : Form
    {
        ...
        private List<VistaFacturaCredito> _clientesMorosos;
        ...
        private void Reporte_De_Cliente_Moroso_Load(object sender, EventArgs e)
        {
            try
            {
                string filePath = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "ReporteClientesMorosos.pdf");
                GenerarPDF(filePath);
                MostrarPDF(filePath);
            }
            catch (Exception ex)
        ...
        public void GenerarPDF(string filePath)
        {
            ...
            try
            {
                ...
                // Obtener los datos de clientes morosos filtrados por fecha
                _clientesMorosos = _context.VistaFacturaCreditos
                    .AsEnumerable()
                    .Where(c => c.FechaVenta >= fechaInicialDateOnly &&
                               c.FechaVenta <= fechaFinalDateOnly &&
                               c.EstadoCredito == "Activo" &&
                               (c.UltimoPago == null || c. < DateTime.Now))
                ...
                headerDiv.Add(new Paragraph("Tienda El Septentrión")
                    ...
                    .SetFontSize(18)
                    .SetMarginBottom(5));
                headerDiv.Add(new Paragraph("Reporte de Clientes Morosos")
                    .SetFont(boldFont)
                    .SetFontSize(16)
                    .SetMarginBottom(5));
                ...
                foreach (var credito in _clientesMorosos)
                {
